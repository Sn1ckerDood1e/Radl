...
Plans:
- [x] 12-01-PLAN.md - Prisma schema (Facility model, enums, relationships)
- [x] 12-02-PLAN.md - RLS helper functions for facility hierarchy
- [x] 12-03-PLAN.md - Update Custom Access Token Hook for facility claims
- [x] 12-04-PLAN.md - Data migration (facility wrappers, equipment ownership)
- [x] 12-05-PLAN.md - RLS policies for facility hierarchy
- [x] 12-06-PLAN.md - TypeScript context helpers (claims, facility-context)
- [x] 12-07-PLAN.md - End-to-end verification
...
Plans:
- [x] 13-01-PLAN.md - CASL ability factory with viewMode support
- [x] 13-02-PLAN.md - Unified context switch API and claims helper
- [x] 13-03-PLAN.md - Context validation and auto-recovery
- [x] 13-04-PLAN.md - Context switcher UI component
- [x] 13-05-PLAN.md - Dashboard layout integration with AbilityProvider
- [x] 13-06-PLAN.md - End-to-end verification
...
Plans:
- [x] 14-01-PLAN.md - shadcn/ui initialization and CSS variable mapping
- [x] 14-02-PLAN.md - Core components installation (Button, Dialog, Select, Input, DropdownMenu)
- [x] 14-03-PLAN.md - Theme toggle UI (header dropdown + settings page)
- [x] 14-04-PLAN.md - Touch targets and migration tracking (CSS + ESLint + README)
...
Plans:
- [x] 15-01-PLAN.md - Dependencies and core libraries (@use-gesture/react, vaul, view transitions)
- [x] 15-02-PLAN.md - Enhanced network status indicator (useSyncStatus hook, SyncStatusIndicator)
- [x] 15-03-PLAN.md - Swipeable list item component (useSwipeGesture, SwipeableListItem)
- [x] 15-04-PLAN.md - Responsive menu system (useMediaQuery, ResponsiveMenu with Drawer/DropdownMenu)
- [x] 15-05-PLAN.md - PWA install enhancement (iOS instructions, usePwaInstall hook, mobile CSS)
- [x] 15-06-PLAN.md - Integration and verification (wire swipes to cards, end-to-end testing)

**Success Criteria:**
1. All pages render correctly on mobile breakpoints (320px, 375px, 414px tested)
2. Interactive elements meet 44px minimum touch target on mobile (buttons, links, drag handles) - DONE IN PHASE 14
...
Plans:
- [x] 16-01-PLAN.md - Empty states and skeleton loading components
- [x] 16-02-PLAN.md - Error handling with retry actions and micro-animations
- [x] 16-03-PLAN.md - Form validation with onTouched mode and inline feedback
- [x] 16-04-PLAN.md - Command palette and keyboard shortcuts
- [x] 16-05-PLAN.md - Onboarding wizard for new users
- [x] 16-06-PLAN.md - Final polish and verification
...
Plans:
- [x] 17-01-PLAN.md - Database schema (EquipmentBooking, BookingStatus, Facility.bookingWindowDays)
- [x] 17-02-PLAN.md - Enhanced facility dashboard with card grid navigation
- [x] 17-03-PLAN.md - Club list page with drill-down navigation
- [x] 17-04-PLAN.md - Facility equipment management (list, create, API)
- [x] 17-05-PLAN.md - Equipment booking helper functions and API
- [x] 17-06-PLAN.md - Equipment requests approval page
- [x] 17-07-PLAN.md - Cross-club event creation and events page
- [x] 17-08-PLAN.md - Facility settings page with booking window config
- [x] 17-09-PLAN.md - Club detail page with subscription overview
- [x] 17-10-PLAN.md - Practice form equipment booking integration
- [x] 17-11-PLAN.md - End-to-end verification
...
| Phase 12: Facility Schema Migration | Complete (7 plans) | 3 | 5 |
| Phase 13: Facility Auth Integration | Complete (6 plans) | 0 (enables 2) | 5 |
| Phase 14: Design System Foundation | Complete (4 plans) | 2 | 5 |
| Phase 15: Mobile PWA Improvements | Complete (6 plans) | 8 | 8 |
| Phase 16: UI/UX Polish | Complete (6 plans) | 7 | 7 |
| Phase 17: Facility UI Features | Complete (11 plans) | 6 | 6 |
...
- Dynamic team colors deferred (stored in DB, UI uses fixed emerald)
- CASL permissions not used in Phase 17 facility APIs (manual role checks)
- shadcn components not heavily used in Phase 17 pages (custom CSS pattern)

**Mitigation applied:**
- Component migration tracking (Phase 14) prevents drift
- RLS connection pooling tests (Phase 12) prevent leaks
- Tenant-aware cache keys (Phase 15) prevent cross-tenant data exposure

## Research Flags

**Phases needing deeper research during planning:**
- **Phase 13:** Custom Access Token Hook with Supabase Edge Functions (memory/timeout constraints) - COMPLETE
- **Phase 17:** Equipment reservation conflict detection (partial boat availability logic) - COMPLETE
...
*Phase 12 completed: 2026-01-23*
*Phase 13 planned: 2026-01-23 (6 plans in 4 waves)*
*Phase 13 completed: 2026-01-23*
*Phase 14 planned: 2026-01-23 (4 plans in 3 waves)*
*Phase 14 completed: 2026-01-24*
*Phase 15 planned: 2026-01-24 (6 plans in 4 waves)*
*Phase 15 completed: 2026-01-24*
*Phase 16 planned: 2026-01-24 (6 plans in 3 waves)*
*Phase 16 completed: 2026-01-24*
*Phase 17 planned: 2026-01-25 (11 plans in 6 waves)*
