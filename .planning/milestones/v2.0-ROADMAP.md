...
Plans:
- [ ] 11-01-PLAN.md - Database schema (MfaBackupCode, PermissionGrant, SsoConfig models)
- [ ] 11-02-PLAN.md - MFA helper functions (Supabase integration, backup codes)
- [ ] 11-03-PLAN.md - MFA API endpoints (enroll, verify, factors, unenroll, backup-codes)
- [ ] 11-04-PLAN.md - Permission grant helper functions
- [ ] 11-05-PLAN.md - Permission grants API and expiration cron job
- [ ] 11-06-PLAN.md - CASL ability integration with permission grants
- [ ] 11-07-PLAN.md - SSO configuration and role mapping utilities
- [ ] 11-08-PLAN.md - SSO configuration API endpoint
- [ ] 11-09-PLAN.md - MFA UI components (setup dialog, verify dialog, backup codes)
- [ ] 11-10-PLAN.md - Security settings page (MFA section, permission grants)
- [ ] 11-11-PLAN.md - SSO settings page (facility admin only)
- [ ] 11-12-PLAN.md - End-to-end verification
...
| Phase 11: MFA & SSO | Planned (12 plans) | 3 | 4 |
