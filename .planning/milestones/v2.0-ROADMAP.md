...
Plans:
- [ ] 14-01-PLAN.md - shadcn/ui initialization and CSS variable mapping
- [ ] 14-02-PLAN.md - Core components installation (Button, Dialog, Select, Input, DropdownMenu)
- [ ] 14-03-PLAN.md - Theme toggle UI (header dropdown + settings page)
- [ ] 14-04-PLAN.md - Touch targets and migration tracking (CSS + ESLint + README)
