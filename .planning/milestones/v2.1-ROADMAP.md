# v2.1 UX Refinement Roadmap (Archived)
...
**Status:** Complete — Shipped 2026-01-27
...
1. **Navigation/Layout Redesign** — Desktop sidebar + mobile bottom nav providing master-detail pattern
2. **Announcements System** — Coach broadcasts with priority levels, practice linking, dashboard display
3. **Public Issue Reporting** — QR-based damage reports with severity routing and email alerts
4. **Equipment Readiness** — Calculated status, visual badges, maintenance workflow
5. **Practice Flow Redesign** — Inline editing, block-based structure, drag-drop lineups, bulk operations
6. **Dashboard Enhancements** — Role-specific dashboards, usage trends, quick actions
7. **Regatta Central Integration** — Calendar display of upcoming regattas with caching
