...
Note: signOut() invalidates the session server-side and clears auth cookies automatically. The context cookies (radl_current_club, radl_current_facility) must be cleared separately using the existing utility functions.
  </action>
  <verify>
