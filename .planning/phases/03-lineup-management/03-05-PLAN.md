...
must_haves:
  ...
  key_links:
    ...
    - from: "src/components/lineups/water-lineup-builder.tsx"
      to: "src/lib/lineup/position-labels.ts"
      via: "import for seat labels"
      pattern: "getSeatsForBoatClass|ROWING_POSITIONS"
...
@.planning/phases/03-lineup-management/03-01-SUMMARY.md (position labels)
...
@src/lib/lineup/position-labels.ts (created in 03-01)
</context>
